...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="public/theme/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<div class="login-box">
    <div class="login-logo">
        <a href="public/theme/index2.html"><b>Admin</b>LTE</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
<!-- Bootstrap 4 -->
<script src="public/theme/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
